...
const CreateLotSelectStartingPrice: React.FC<Props> = ({ control, error }) => {
  ...
  return (
    <BaseFlex flexDirection={FlexDirection.COLUMN} className={styles.section}>
      <BaseTypography
        ...
        weight="bold"
        size="lg"
        value={t<string>('auctions.create.step2.title6')}
      />
        ...
        <Controller
          ...
          render={({ field: { ref, ...rest } }) => (
            <LabelInputNumber
              ...
              label={t('auctions.create.step2.startingPriceLabel')}
              {...rest}
            />
          )} 
        />
...
export default React.memo(CreateLotSelectStartingPrice);
